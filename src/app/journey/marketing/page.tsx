...
export default function MarketingPage() {
    const resources: Resource[] = [
        { title: "Traction - Gabriel Weinberg", type: "book", completed: false },
        { title: "Hacking Growth", type: "book", completed: false },
        { title: "Reforge Growth Series", type: "course", completed: false },
    ];

    const learningLog: LogEntry[] = [
        {
            date: "January 15, 2026",
            content: "Growth is not magic, it's a process. Understanding channels and loops."
        },
    ];

    const keyInsights = [
        "Product-Market Fit comes before Growth",
                ...
                <Container>
                    <motion.div initial="hidden" animate="show" variants={containerVariants} className="animate-fade-in-up">
                        ...
                        <motion.p variants={itemVariants} style={{
                            ...
                            Growth strategies, user acquisition, dan bagaimana caranya biar orang tau produk lo exist.
                        </motion.p>
                    </motion.div>
                </Container>
            </section>
