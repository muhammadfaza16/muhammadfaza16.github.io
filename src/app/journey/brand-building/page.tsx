...
export default function BrandBuildingPage() {
    const resources: Resource[] = [
        { title: "Building a StoryBrand - Donald Miller", type: "book", completed: false },
        { title: "Start With Why - Simon Sinek", type: "book", completed: false },
        { title: "Personal Branding Masterclass", type: "course", completed: false },
    ];

    const learningLog: LogEntry[] = [
        {
            date: "January 15, 2026",
            content: "Starting to explore what makes a brand memorable. The intersection of authenticity and strategy is interesting."
        },
    ];
                ...
                <Container>
                    <motion.div initial="hidden" animate="show" variants={containerVariants} className="animate-fade-in-up">
                        ...
                        <motion.div variants={itemVariants} style={{ display: "flex", alignItems: "center", gap: "1rem", marginBottom: "clamp(1rem, 2vh, 1.5rem)" }}>
                            ...
                            <div>
                                ...
                                <div style={{
                                    ...
                                    <span style={{ width: "6px", height: "6px", borderRadius: "50%", backgroundColor: "#22c55e", animation: "pulse 2s ease-in-out infinite" }} />
                                    In Progress · 20%
                                </div>
                            </div>
                        </motion.div>
                        ...
                        <motion.p variants={itemVariants} style={{
                            ...
                            Crafting authentic personal and product brands. Learning to tell stories that resonate and build trust.
                        </motion.p>
                    </motion.div>
                </Container>
            </section>
