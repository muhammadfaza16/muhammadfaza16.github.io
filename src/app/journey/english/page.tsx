...
export default function EnglishPage() {
    const resources: Resource[] = [
        { title: "Advanced Grammar in Use - Cambridge", type: "book", completed: true },
        { title: "The Economist Subscription", type: "tool", completed: true },
        { title: "Pronunciation Workshop", type: "course", completed: false },
    ];

    const learningLog: LogEntry[] = [
        {
            date: "January 15, 2026",
            content: "Focusing on consuming native-level content. Podcasts, essays, and technical documentation."
        },
    ];
                ...
                <Container>
                    <motion.div initial="hidden" animate="show" variants={containerVariants} className="animate-fade-in-up">
                        ...
                        <motion.p variants={itemVariants} style={{
                            ...
                            Leveling up communication skills. From good enough to genuinely fluent. Focus on nuance, idiom, and cultural context.
                        </motion.p>
                    </motion.div>
                </Container>
            </section>
