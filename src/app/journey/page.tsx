                    ...
                    <Container>
                        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                            ...
                            <div style={{ textAlign: "center", position: "absolute", left: "50%", transform: "translateX(-50%)" }}>
                                <span style={{ fontSize: "0.7rem", fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase", color: "#af52de", display: "block", marginBottom: "2px" }}>The Starlight</span>
                                <h1 style={{ fontSize: "1.1rem", fontWeight: 600, margin: 0 }}>The Journey</h1>
                            </div>
