                    ...
                    {isLoading ? (
                        ...
                        >
                            {[1, 2, 3, 4].map((i) => (
                                <div
                                    key={`skeleton-${i}`}
                                    className="relative overflow-hidden w-full flex items-center justify-between py-4 px-4 min-h-[90px] bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl shadow-sm"
                                >
                                    {/* Shimmer Effect */}
                                    <div
                                    ...
                                    <div className="flex flex-col flex-1 pr-6 min-w-0 justify-center">
                                        <div className="w-16 h-2.5 bg-zinc-300/30 rounded-full mb-3" />
                                        <div className="w-11/12 h-4 bg-zinc-300/30 rounded-full mb-2" />
                                        <div className="w-3/4 h-4 bg-zinc-300/30 rounded-full" />
                                    </div>

                                    {/* Thumbnail 3:4 aspect ratio block */}
                                    <div className="w-[48px] h-[64px] rounded-[10px] bg-zinc-300/30 shrink-0 border border-white/5" />
                                </div>
                            ))}
                        </motion.div>
                        ...
                        <motion.div
                            ...
                            className="flex flex-col items-center justify-center py-20 opacity-50 text-zinc-400"
                        >
                            <Bookmark size={48} className="mb-4" strokeWidth={1.5} />
                            <p className="text-lg font-medium tracking-tight">No articles found.</p>
                        </motion.div>
                    ) : (
                        <motion.div key="list" className="flex flex-col w-full" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.3 }}>
                            <AnimatePresence>
